...
class Ololo_AdminController extends Controller {
	...
	public function display_new(){
		...
		$variables = array_merge($_POST, array(
			'instanceId' => 0,
			'pageTitle'  => $pageTitle,
			'validation' => Ololo_Model::create()->getValidator()->getJsRules(),
		));
	...
	public function display_edit($instanceId = null){
		...
		$instance = Ololo_Model::load($instanceId);
	...
	public function action_save(){
		...
		$instance = new Ololo_Model($instanceId);
		$saveMode = $instance->isNewObj ? Ololo_Model::SAVE_CREATE : Ololo_Model::SAVE_EDIT;
