...
<form id="regForm" name="regForm" action="" method="post">
	...
	{/if}
		...
		<tr>
			...
			<td>
				Число <select name="birth[day]">  <option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>{$days_list}</select>
				Месяц <select name="birth[month]"><option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>{$months_list}</select>
				Год   <select name="birth[year]"> <option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>{$years_list}</select>
			</td>
		</tr>
		<tr>
